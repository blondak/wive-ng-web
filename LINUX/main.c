...
static char_t		*rootWeb = T("/home/zdjur/web/wive-ng/filesystem/web");			/* Root web directory */
static char_t		*password = T("");				/* Security password */
static int			port = 1080;						/* Server port */
